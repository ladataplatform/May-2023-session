...
exec sp_blitzIndex @DatabaseName ='ContosoRetailDW', @TableName = 'FactOnlineSales', @SchemaName = 'dbo'
exec sp_blitzIndex @DatabaseName ='ContosoRetailDW', @TableName = 'DimProduct', @SchemaName = 'dbo'
exec sp_blitzIndex @DatabaseName ='ContosoRetailDW', @TableName = 'DimDate', @SchemaName = 'dbo'
exec sp_blitzIndex @DatabaseName ='ContosoRetailDW', @TableName = 'DimStore', @SchemaName = 'dbo'
...
Table 'FactOnlineSales'. Scan count 3, logical reads 46,965, physical reads 1, page server reads 0, read-ahead reads 46491, page server read-ahead reads 0, lob logical reads 0, lob physical reads 0, lob page server reads 0, lob read-ahead reads 0, lob page server read-ahead reads 0.
...
Table 'Worktable'. Scan count 0, logical reads 0, physical reads 0, page server reads 0, read-ahead reads 0, page server read-ahead reads 0, lob logical reads 0, lob physical reads 0, lob page server reads 0, lob read-ahead reads 0, lob page server read-ahead reads 0.
Table 'Workfile'. Scan count 0, logical reads 0, physical reads 0, page server reads 0, read-ahead reads 0, page server read-ahead reads 0, lob logical reads 0, lob physical reads 0, lob page server reads 0, lob read-ahead reads 0, lob page server read-ahead reads 0.
Table 'FactOnlineSales'. Scan count 1, logical reads 13109, physical reads 0, page server reads 0, read-ahead reads 0, page server read-ahead reads 0, lob logical reads 0, lob physical reads 0, lob page server reads 0, lob read-ahead reads 0, lob page server read-ahead reads 0.
